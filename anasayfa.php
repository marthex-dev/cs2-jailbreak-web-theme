...
<!--================== WebNetwork ================== -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="third-banner-content text-center wow bounceInUp" data-wow-delay=".2s">
                                <h2>Okyanus<span> Jaılbreak</span></h2>
 ...
 <!-- /Başlangıç Sunucu ekleme-->
							...
							$sw_cek = file_get_contents('http://api.steampowered.com/ISteamApps/GetServersAtAddress/v0001?addr=185.193.165.142&format=json');

							$sw_oku = json_decode($sw_cek, true);

							if($sw_oku['response']['success'] == true){

								$durum = "Aktif";

								$data = json_decode(file_get_contents('https://api.steampowered.com/IGameServersService/GetServerList/v1/?filter=\appid\730\addr\185.193.165.142:27015&key=D14A861250F882ABE8BFC51602963A74'));

								$main = $data->response->servers[0];

								$oyuncu_sayisi = $main->players;

								$max_oyuncu_sayisi = $main->max_players;					
							...
							if($durum === "Aktif"){
								...
								?><p style="font-size: 14px"><b>Sunucu: <span style='color: red'>Kapalı!</span></b></p><?php																						
                                    ...
                                    <div class="my-info-box-content">
                                        <div class="my-info-social">
                                            <ul>
                                                ...
                                                <li><a></i> <?php echo $oyuncu_sayisi; ?>/<?php echo $max_oyuncu_sayisi; ?> </a></li>
